...
def insert_bank(self):
    with open('C:\\Users\\hp\\OneDrive\\Desktop\\djangoproject\\Sonali\\Scripts\\project37\\app\\bank.csv','r') as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0].strip()#for erase unwanted indent uu
...
def insert_branch(self):
    with open('C:\\Users\\hp\\OneDrive\\Desktop\\djangoproject\\Sonali\\Scripts\\project37\\app\\branch1.csv','r') as FO:
        IOD=csv.reader(FO)
        next(IOD)
        for i in IOD:
            bn=i[0]
